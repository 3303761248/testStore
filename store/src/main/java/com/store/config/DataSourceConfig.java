...
@Configuration
@MapperScan(basePackages = "com.store.*.dao", sqlSessionTemplateRef = "test1SqlSessionTemplate")
...
/**
    ...
    public ShardingRule shardingRule(DataSourceRule dataSourceRule){
        //具体分库分表策略
        TableRule orderTableRule = TableRule.builder("t_good_master")
                .actualTables(Arrays.asList("t_good_master_0", "t_good_master_1"))
                .tableShardingStrategy(new TableShardingStrategy("good_code", new TableShardingAlgorithm()))
        ...
        return ShardingRule.builder()
                ...
                .databaseShardingStrategy(new DatabaseShardingStrategy("good_code", new DatabaseShardingAlgorithm()))
                .tableShardingStrategy(new TableShardingStrategy("good_code", new TableShardingAlgorithm()))
                .build();
    }
